...
### DoWhat 主界面
![DoWhat 主界面](./resources/DoWhat.png)

*DoWhat 主看板展示活动时间轴、AI 生成的摘要和任务管理功能*

### OpenClaw 集成
![OpenClaw 集成](./resources/openclaw.png)

*内置 OpenClaw 智能体，支持 IM 集成和自主任务执行*
...
### 🤖 OpenClaw 集成
- **零配置启动**：自动复用 DoWhat 的 API Key
- **IM 连接**：支持连接微信或飞书进行即时通讯
- **智能体执行**：从 Backlog 一键委派任务给 OpenClaw 自主完成
- **本地优先**：完全运行在 Electron 内，无外部依赖
...
│   ├── StatsView          — 使用统计与洞察报告
│   ├── OpenClawView       — OpenClaw 智能体界面与 IM 配置
...
**技术栈**：Electron 39 · React 19 · TypeScript 5 · Tailwind CSS 4 · SQLite (better-sqlite3) · OpenAI SDK · OpenClaw · electron-vite
